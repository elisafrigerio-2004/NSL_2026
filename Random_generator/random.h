...
public:
  ...
  //AGGIUNTE PER ES 01.2
  //Metodo per generare un numero random con una distribuzione esponenziale
  double Exponential(double lambda); 
  //Metodo per generare un numero random con una distribuzione lorentziana 
